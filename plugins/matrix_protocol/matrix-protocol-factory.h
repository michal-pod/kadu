...
class MatrixProtocolFactory final : public ProtocolFactory
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit MatrixProtocolFactory(QObject *parent = nullptr);
    virtual ~MatrixProtocolFactory() = default;
    ...
    virtual AccountEditWidget *newEditAccountWidget(Account account, QWidget *parent) override;
    virtual QList<StatusType> supportedStatusTypes() override;
    virtual Status adaptStatus(Status status) const override;
