...
class MatrixPluginModulesFactory : public PluginModulesFactory
{
    Q_OBJECT
...
public:
    explicit MatrixPluginModulesFactory(QObject *parent = nullptr);
    virtual ~MatrixPluginModulesFactory();
