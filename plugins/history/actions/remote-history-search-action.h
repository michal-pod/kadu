...
class RemoteHistorySearchAction final : public ActionDescription
{
    Q_OBJECT

public:
    Q_INVOKABLE explicit RemoteHistorySearchAction(QObject *parent = nullptr);
    virtual ~RemoteHistorySearchAction() = default;
