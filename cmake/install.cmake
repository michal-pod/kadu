...
if (WIN32)
	# Kadu resolves data relative to the executable on Windows. Keep the
	# application distributable as one directory rather than using GNU's
	# Unix-style bin/, lib/, and share/ hierarchy.
	set (INSTALL_BIN_DIR ".")
	set (INSTALL_LIB_DIR ".")
	set (INSTALL_DATA_DIR ".")
	set (INSTALL_PLUGINS_DATA_DIR "plugins")
	set (INSTALL_PLUGINS_LIB_DIR "plugins")
	set (INSTALL_INCLUDE_DIR "sdk/include/kadu")
	set (INSTALL_CMAKE_DIR "sdk/cmake/Kadu")
else ()
